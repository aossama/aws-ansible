...
# Clouformation specifics
@click.option('--stack-name', default='aws-infra', help='Cloudformation stack name. Must be unique', show_default=True)

# AWS/EC2 specifics
@click.option('--region', default='us-east-1', help='ec2 region', show_default=True)
@click.option('--ami', default='ami-a33668b4', help='ec2 ami', show_default=True)
...
def launch_env(stack_name=None,
    ...
    click.echo('\tPublic Hosted Zone: %s' % public_hosted_zone)
    click.echo("")
